			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x"><p style="color:white;">Hostel Management System Horizon Campus</p></h1>
...
<p> Hostel Management System - Horizon Campus</p>
</footer> </div>
